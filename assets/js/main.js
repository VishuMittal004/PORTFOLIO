...
(function ($) {
  ...
  var tmPk = {
    ...
    swiperJs: function () {
      ...
      // Add project section swiper
      $(document).ready(function () {
        var swiper = new Swiper(".client-testimonial-swiper", {
          slidesPerView: 3,
          spaceBetween: 30,
          loop: true,
          autoplay: {
          ...
          navigation: {
            nextEl: ".swiper-button-next.project-nav-btn",
            prevEl: ".swiper-button-prev.project-nav-btn",
          },
          breakpoints: {
            0: {
              slidesPerView: 1,
    ...
    stickyHeader: function (e) {
      // Removed scroll event listener to prevent header from becoming sticky
    },
